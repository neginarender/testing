<header class="p-3 bg-dark text-white">
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      @auth
        <div class="text-end">
          <a class="btn btn-outline-light me-2" href="{{ route('profiles.show',auth()->id()) }}">{{ucwords(auth()->user()->name)}}</a>
          <a href="#" class="btn btn-outline-light me-2" onclick="event.preventDefault(); localStorage.clear();  document.getElementById('logout-form').submit();">Logout</a>
